...
app.post("/turn", requireAuth, async (req, res) => {
  try {
    ...
    const system = [
      ...
      "7. Учитывай характеристики игрока: сила — силовые действия; ловкость — уклонение, скорость, точность; интеллект — анализ, хитрость, древние знания, магические символы. Других быть не может. В choices, если ссылаешься на них — пиши на русском в скобках",
